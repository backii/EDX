...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        dict_low = {string.ascii_lowercase[x]: string.ascii_lowercase[(x + shift) % 26] for x in
                    range(len(string.ascii_lowercase))}

        dict_up = {string.ascii_uppercase[x]: string.ascii_uppercase[(x + shift) % 26] for x in
    ...
    def apply_shift(self, shift):
        ...
        '''
        crypted = self.build_shift_dict(shift)
        crypted_message=''
